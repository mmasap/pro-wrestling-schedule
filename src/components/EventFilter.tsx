	...
	return (
		<div class="space-y-4">
			...
			<div class="flex flex-wrap items-center gap-2">
				<span class="text-xs font-semibold text-zinc-400 uppercase tracking-widest w-12 shrink-0">
					団体
				</span>
			...
			<div class="flex flex-wrap items-center gap-4">
				...
				<div class="flex items-center gap-2">
					<span class="text-xs font-semibold text-zinc-400 uppercase tracking-widest shrink-0 whitespace-nowrap">
						都道府県
					</span>
					<select
				...
				<table class="w-full text-sm border-collapse">
					<thead>
						<tr class="bg-zinc-900 border-b border-zinc-700">
							<th class="text-left px-4 py-2.5 text-xs font-semibold text-zinc-400 uppercase tracking-wider whitespace-nowrap w-32">
								日付
							</th>
							...
							<th class="text-left px-4 py-2.5 text-xs font-semibold text-zinc-400 uppercase tracking-wider whitespace-nowrap w-20 hidden sm:table-cell">
								都道府県
							</th>
						</tr>
					</thead>
					<tbody>
						{filtered.map((e, i) => (
							...
							>
								...
								<td class="px-4 py-2.5 text-zinc-500 hidden sm:table-cell">
									{e.prefecture}
								</td>
							</tr>
						))}
